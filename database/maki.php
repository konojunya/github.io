...
session_start();
if($_SESSION['token'] === sha1("sxdcfvgbhbvtcrd345678gfdxsdcfvgbh")){
...
connectDB();
//データベースに書き込み
$insert = mysql_query('insert into maki(month,day,starttime,endtime,contents) values('.$month.','.$day.','.$starttime.','.$endtime.','.'"'.$contents.'"'.');');
