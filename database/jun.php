...
session_start();
if($_SESSION['token'] === sha1("aesrdtfyguh234567dxcfghv")){
...
connectDB();
//データベースに書き込み
$insert = mysql_query('insert into jun(month,day,starttime,endtime,contents) values('.$month.','.$day.','.$starttime.','.$endtime.','.'"'.$contents.'"'.');');
