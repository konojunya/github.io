...
session_start();
if($_SESSION['token'] === sha1("sxdcfvgh45678wertgvdcvfbnhgbvcd")){
...
connectDB();
//データベースに書き込み
$insert = mysql_query('insert into saya(month,day,starttime,endtime,contents) values('.$month.','.$day.','.$starttime.','.$endtime.','.'"'.$contents.'"'.');');
